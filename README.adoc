...
image:https://github.com/vert-x3/vertx-stomp/workflows/CI/badge.svg?branch=master["Build Status", link="https://github.com/vert-x3/vertx-stomp/actions?query=workflow%3ACI"]
