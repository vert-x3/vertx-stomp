...
`link:../../jsdoc/net_server-NetServer.html[NetServer]`, so you can configure the underlying `link:../../jsdoc/net_server-NetServer.html[NetServer]` from
the `link:../dataobjects.html#StompServerOptions[StompServerOptions]`. Alternatively you can also pass the
`link:../../jsdoc/net_server-NetServer.html[NetServer]` you want to use:
...
Enabling security requires an additional `link:../../jsdoc/auth_provider-AuthProvider.html[AuthProvider]` handling the
...
More information about `link:../../jsdoc/auth_provider-AuthProvider.html[AuthProvider]` is available
...
`link:../../jsdoc/stomp_client_connection-StompClientConnection.html#connectionDroppedHandler[connectionDroppedHandler]`. The handler can
...
STOMP client relies on a `link:../../jsdoc/net_client-NetClient.html[NetClient]`, you can configure the underlying Net Client from
the `link:../dataobjects.html#StompClientOptions[StompClientOptions]`. Alternatively, you can pass the `link:../../jsdoc/net_client-NetClient.html[NetClient]`
...
`link:../../jsdoc/stomp_server-StompServer.html#webSocketHandler[webSocketHandler]` result to
`link:../../jsdoc/http_server-HttpServer.html#websocketHandler[websocketHandler]`:
