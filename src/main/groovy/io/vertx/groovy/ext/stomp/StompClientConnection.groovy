...
public class StompClientConnection {
  ...
  public String subscribe(String destination, FrameHandler handler) {
    def ret = this.delegate.subscribe(destination, (io.vertx.ext.stomp.FrameHandler)handler.getDelegate());
    return ret;
  }
  /**
   * Subscribes to the given destination. This destination is used as subscription id.
   ...
   * @return the subscription id.
   */
  public String subscribe(String destination, FrameHandler handler, Handler<Map<String, Object>> receiptHandler) {
    def ret = this.delegate.subscribe(destination, (io.vertx.ext.stomp.FrameHandler)handler.getDelegate(), new Handler<Frame>() {
      public void handle(Frame event) {
        receiptHandler.handle((Map<String, Object>)InternalHelper.wrapObject(event?.toJson()));
      }
    });
  ...
  public String subscribe(String destination, Map<String,String> headers, FrameHandler handler) {
    def ret = this.delegate.subscribe(destination, headers, (io.vertx.ext.stomp.FrameHandler)handler.getDelegate());
    return ret;
  }
  /**
   * Subscribes to the given destination.
   ...
   * @return the subscription id, which can either be the destination or the id set in the headers.
   */
  public String subscribe(String destination, Map<String,String> headers, FrameHandler handler, Handler<Map<String, Object>> receiptHandler) {
    def ret = this.delegate.subscribe(destination, headers, (io.vertx.ext.stomp.FrameHandler)handler.getDelegate(), new Handler<Frame>() {
      public void handle(Frame event) {
        receiptHandler.handle((Map<String, Object>)InternalHelper.wrapObject(event?.toJson()));
      }
    });
   ...
   * @return the current {@link io.vertx.groovy.ext.stomp.StompClientConnection}
   */
  public StompClientConnection ack(Map<String, Object> frame = [:]) {
    this.delegate.ack(frame != null ? new io.vertx.ext.stomp.Frame(new io.vertx.core.json.JsonObject(frame)) : null);
    return this;
  }
  /**
   * Sends an acknowledgement for the given frame. It means that the frame has been handled and processed by the client.
   ...
   * @return the current {@link io.vertx.groovy.ext.stomp.StompClientConnection}
   */
  public StompClientConnection ack(Map<String, Object> frame = [:], Handler<Map<String, Object>> receiptHandler) {
    this.delegate.ack(frame != null ? new io.vertx.ext.stomp.Frame(new io.vertx.core.json.JsonObject(frame)) : null, new Handler<Frame>() {
      public void handle(Frame event) {
        receiptHandler.handle((Map<String, Object>)InternalHelper.wrapObject(event?.toJson()));
      }
    });
   ...
   * @return the current {@link io.vertx.groovy.ext.stomp.StompClientConnection}
   */
  public StompClientConnection nack(Map<String, Object> frame = [:]) {
    this.delegate.nack(frame != null ? new io.vertx.ext.stomp.Frame(new io.vertx.core.json.JsonObject(frame)) : null);
    return this;
  }
  /**
   * Sends a non-acknowledgement for the given frame. It means that the frame has not been handled by the client.
   ...
   * @return the current {@link io.vertx.groovy.ext.stomp.StompClientConnection}
   */
  public StompClientConnection nack(Map<String, Object> frame = [:], Handler<Map<String, Object>> receiptHandler) {
    this.delegate.nack(frame != null ? new io.vertx.ext.stomp.Frame(new io.vertx.core.json.JsonObject(frame)) : null, new Handler<Frame>() {
      public void handle(Frame event) {
        receiptHandler.handle((Map<String, Object>)InternalHelper.wrapObject(event?.toJson()));
      }
    });
   ...
   * @return the current {@link io.vertx.groovy.ext.stomp.StompClientConnection}
   */
  public StompClientConnection ack(Map<String, Object> frame = [:], String txId) {
    this.delegate.ack(frame != null ? new io.vertx.ext.stomp.Frame(new io.vertx.core.json.JsonObject(frame)) : null, txId);
    return this;
  }
  /**
   * Sends an acknowledgement for the given frame. It means that the frame has been handled and processed by the
   ...
   * @return the current {@link io.vertx.groovy.ext.stomp.StompClientConnection}
   */
  public StompClientConnection ack(Map<String, Object> frame = [:], String txId, Handler<Map<String, Object>> receiptHandler) {
    this.delegate.ack(frame != null ? new io.vertx.ext.stomp.Frame(new io.vertx.core.json.JsonObject(frame)) : null, txId, new Handler<Frame>() {
      public void handle(Frame event) {
        receiptHandler.handle((Map<String, Object>)InternalHelper.wrapObject(event?.toJson()));
      }
    });
   ...
   * @return the current {@link io.vertx.groovy.ext.stomp.StompClientConnection}
   */
  public StompClientConnection nack(Map<String, Object> frame = [:], String txId) {
    this.delegate.nack(frame != null ? new io.vertx.ext.stomp.Frame(new io.vertx.core.json.JsonObject(frame)) : null, txId);
    return this;
  }
  /**
   * Sends a non-acknowledgement for the given frame. It means that the frame has not been handled by the client.
   ...
   * @return the current {@link io.vertx.groovy.ext.stomp.StompClientConnection}
   */
  public StompClientConnection nack(Map<String, Object> frame = [:], String txId, Handler<Map<String, Object>> receiptHandler) {
    this.delegate.nack(frame != null ? new io.vertx.ext.stomp.Frame(new io.vertx.core.json.JsonObject(frame)) : null, txId, new Handler<Frame>() {
      public void handle(Frame event) {
        receiptHandler.handle((Map<String, Object>)InternalHelper.wrapObject(event?.toJson()));
      }
    });
